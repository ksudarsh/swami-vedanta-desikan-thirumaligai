...
The page should primarily speak to:

- devotees of Sri Vedanta Desikan's sampradayam
...
- WordPress page template: `Unboxed Content`
- Deliverable: custom HTML fragment with scoped CSS
- Do not include full-document tags such as `<!DOCTYPE html>`, `<html>`, `<head>`, or `<body>`
- Keep CSS locally scoped to avoid interfering with site theme styles

## Current Source Material In Folder

### Images

- `srirangam-renovation-grant-request-letter.jpg`
- `acharyan-renovation-approval-letter.jpg`
- `swami-desikan-thirumaligai-front.jpg`
- `acharyan-visit-srirangam-mutt-2019.jpg`
...
- The official page also says the premises needs convenience features to support the **stay of the Acharyan and parivaram** during visits to Srirangam.
...
- A 2010 blog post says Swami Desikan lived at this Thirumaligai in Srirangam for approximately **42 years**.
...
2. **Living religious and cultural continuity**
   
   - mention ongoing worship, observances, pathams, and kalakshepams
   - show that this is not a dead monument but a living sacred site
...
4. Restoration project status
   
   1. show that restoration work has already begun and therefore funds are immediately needed
   
   2. The bhoomi pooja pictures should be shown here (not on top). 
   
   3. Renovation plan details including milestones, timelines should be shown here

5. **Appeal for donor support**
   ...
   - provide room for donor recognition, including current major / minor contributors - show PLM USA as first donor.
...
1. Hero / title block
2. Why this Thirumaligai matters
3. Historic and sampradaya significance
4. Connection to Parakala Matham and current religious life
...
This page is expected to eventually include:
...
- Working note: the initial amount may need to be updated from **Rs. 25 lakhs** to **Rs. 27 lakhs** depending on confirmation.
- Mention that given the state of the structure as work progresses new problems may be uncovered therefore funding requirements may increase.
...
A project-specific Word document should be maintained and sent to the principals / local managers to gather:

- approved historical wording
...
This project will go through multiple iterations. The initial goal is:

- set up the new project repo correctly
- preserve the source material
- create the working requirements
- prepare the principal questionnaire
- gather clarifications before finalizing the donor-facing HTML page
